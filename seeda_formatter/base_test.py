...
data = seeda.data[0]
assert data['previous'] == "Genetic risk does carry its consequences and should not be taken lightly within the family circle ."
assert data['following'] == "In cases where an individual has gotten to know of a genetic disorder , disclosing or otherwise , to his or her relative is solely a matter of preference within the indivdial moral system ."
assert data['source'] == "Afterall , what affects one family may or may not affect another although the families has a common genetic make up , shared by either of the parents ."
assert data['errors'] == [
    edit_cls(o_start=15, o_end=16)
]
assert data['edits'][0] == [
